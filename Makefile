...
CXXFLAGS=	-std=c++11 -Wall -g -O2 -Wno-write-strings -Wstrict-aliasing ${DEFINES}
...
OBJS=	chost.o strupr.o getmem.o Xerror.o Xquery.o Xfile.o Xwarn.o \
	...
	tapeIO.o tapeIO++.o OAProbeFactory.o TextFile.o F2DS.o
...
SRCS=	chost.c strupr.c getmem.c Xerror.c Xquery.c Xfile.c Xwarn.c \
	...
	tapeIO.c tapeIO++.c OAProbeFactory.cc TextFile.cc F2DS.cc
...
F2DS.o:		F2DS.h Probe.h OAPUserConfig.h
